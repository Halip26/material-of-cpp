...
int main()
{
    ...
    if (continue_answer == "YES" or continue_answer == "yes")
    {
      ...
      if (token_buy_answer == "YES" or continue_answer == "yes")
      {
        ...
        else
        {
          ...
          if (guess <= 0 || guess > 10)
          {
            cout << "\nNumber Should Be Between 1 To 10. Program wiil exit now!";
            exit(0);
          }
          else
          {
  ...
  else if (18 < age && age < 60)
  {
    ...
    {
      cout << "\nTo play the game you'll have to purachase 300 tokens for 50 dollars. Do you accept(Enter YES to confirm): ";
      cin >> token_buy_answer;
      if (token_buy_answer == "YES" || token_buy_answer == "yes")
      {
        ...
        if (bet_amount > balance_amount)
        {
          cout << "You can not bid more than current amount. Program will exit now!";
          exit(0);
        }
        else
        {
